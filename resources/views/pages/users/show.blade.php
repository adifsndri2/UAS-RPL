            ...
            <div class="row">
                <div class="col-12 col-lg-4 mb-5 mb-lg-0">
                    ...
                    <div>
                        ...
                        <a id="share-page" class="btn btn-primary me-4" href="javascrip:;">Share</a>
                        @auth
                            @if ($user->id === auth()->id())
                                ...
                                <div class="card card-discussions">
                                    <div class="row align-items-center">
                                        <div class="col-2 col-lg-1 text-center">
                                            {{ $answer->likeCount }} like
                                        </div>
                                        <div class="col">
                                            <span>Replied to</span>
                                            <span class="fw-bold text-primary">
                                                <a href="{{ route('discussions.show', $answer->discussion->slug ?? '') }}">
                                                    {{ $answer->discussion->title ?? 'This discussion deleted'}}
                                                </a>
                                            </span>
                                            <span class="fs-12px color-gray">
                                                <div>
                                                    Answer {{ $answer->created_at->diffforhumans() }}
