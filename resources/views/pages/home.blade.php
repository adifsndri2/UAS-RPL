          ...
          <section class="container hero">
            <div class="row align-items-center h-100">
              <div class="col-12 col-lg-6">
                ...
                <p class="mb-4">Comunity forum to connect, share and learn</p>
          ...
          <section class="bg-gray">
            <div class="container py-80px">
              ...
              <div class="row">
                      ...
                      <div class="row">
                        <div class="col me-1 me-lg-2">
                          <a href="{{ route('discussions.categories.show', $latestDiscussion->category->slug) }}">
                            <span class="bagde rounded-pill text-bg-light">{{ $latestDiscussion->category->name }}</span></a>
                        </div>
                        <div class="col-5 col-lg-7">
                          <div class="avatar-sm-wrapper d-inline-block">
                            <a href="{{ route('users.show', $latestDiscussion->user->username ?? '') }}" class="me-1">
                              <img class="avatar rounded-circle" src="{{ filter_var($latestDiscussion->user->picture ?? '', FILTER_VALIDATE_URL) 
                ...
                @empty
                  <div class="card card-discussions d-flex justify-content-center">
                    Curently no discussion yet
                  </div>
                @endforelse
                </div>
              </div>
